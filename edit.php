...
?>
  ...
  <div class="content-wrapper new-entry">
    ...
    <section class="content-header" style="background: red; height: 50px;">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-code"></i> <?php echo $snippet->get_title(); ?></a></li>
        <li class="active">Edit <?php echo $entry->get_name(); ?></li>
      </ol>
    </section>
...
?>
	...
	<form action="app/process/edit_process.php" method="post">
		<div class="row">
			<div class="col-md-8">
				...
				<textarea name="entry" data-editor="text" type="text"><?php echo $entry->get_content(); ?></textarea>
			</div>
				...
				<div class="box-body">
					...
					<script type="text/javascript">
						$(document).ready(function() {
							$('.langpicker option[value="<?php echo $entry->get_language(); ?>"]').attr("selected",true);
							$(".langpicker").select2();
						});
					</script>
	...
	<?php
			...
			echo '<div class="callout callout-danger"><h4><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Permission denied.</h4><p>You can\'t add edit an entry don\'t own!</p></div>';
		}
		
		} 
		else {
			// Not found error message
			echo '<div class="callout callout-danger"><h4><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Entry not found!</h4><p>It may have been deleted by the author.</p></div>';
		}
	?>
