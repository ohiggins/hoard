...
<p><label>Entry Title:</label> <input tabindex="1" id="start-here" name="title" value="<?php echo htmlspecialchars($entry->get_name()); ?>" type="text" placeholder="test" /></p>
<p><label>Snippet Entry:</label> <textarea name="entry" type="text"><?php echo htmlspecialchars($entry->get_content()); ?></textarea></p>
...
<?php
	...
	echo '
        ...
        <p>You can\'t edit an entry to a snippet you don\'t own!</p>
        </div>';
	}
	} 
	else {
	echo '
		<div class="callout callout-danger">
        <h4><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Entry not found!</h4>
